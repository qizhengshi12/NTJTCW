...
public class TjbbYxzbQyZxm {
	private int id;//统计报表——客运出站运输量统计表（汽运集团）——子项目
	private int xmid;//主表项目ID
	private String zb1;//上月数
	private String zb2;//本月数
	private String zb3;//环比增减%
	private String zb4;//年初累计
	private String zb5;//上年同期累计
	private String zb6;//上年同期同比%
	public int getId() {
		return id;
	}
