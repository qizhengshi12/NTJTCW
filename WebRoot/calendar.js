...
{   
	...
	var nowDates=nowDate.getTime();  
	if(starttimes<=nowDates)    
	{   
		return false;   
	}   
	else{
...
function dateTimeCompareNow(dateTime)   
{   
	...
	var starttime=new Date(arr1[0],arr1[1],arr1[2],arr2[0],arr2[1]);    
	var starttimes=starttime.getTime();  
	...
	var nowDate=new Date(year,month,day,hour,min);
	var nowDates=nowDate.getTime();  
	if(starttimes<=nowDates)    
	{   
		return false;   
