  ...
  <body>
	...
	<table id="table1" width="100%" border=0  cellpadding=0 cellspacing=1 style="">
		...
		<tr class="tr2" onmouseover="this.style.backgroundColor='#EBEBEB';" onmouseOut="this.style.backgroundColor='';">
			...
			<%if(UserPer.getJjyxfx().indexOf("3")!=-1 || UserPer.getJjyxfx().indexOf("4")!=-1){%>
			<td align="center">
				<%if("管理员".equals(roles)||((username.equals(jjyxfx.getCzrID())&&"2".equals(jjyxfx.getTjzt())&&UserPer.getJjyxfx().indexOf("3")!=-1))){%>
					<a href="CwjdServlet?action=JjyxfxEdit&id=<%=jjyxfx.getId()%>"><img  alt="编辑" title="编辑" src="images/small/options.png"></a>
				<%} %>
				<%if("管理员".equals(roles)||(("信息员".equals(roles)||"统计负责人".equals(roles))&&"局机关".equals(company))||((username.equals(jjyxfx.getCzrID())&&"2".equals(jjyxfx.getTjzt())&&UserPer.getJjyxfx().indexOf("4")!=-1))){%>
					<a href="CwjdServlet?action=JjyxfxDelete&id=<%=jjyxfx.getId()%>&FileUrl=<%=jjyxfx.getFileUrl()%>" onclick="javascript:return confirm('确定删除此记录？');"><img  alt="删除" title="删除" src="images/small/burn.png"></a>
			 	<%} %>
			</td>
			<%} %>
		</tr>
