  ...
  <body>
		...
		<table width="100%" >
			<tr>
				<td>
					...
					<img align="middle" width="30px" height="30px" alt="查询" title="查询" style="cursor: pointer;" src="images/small/find.png" onclick="queryTjbbYxzbHsZdByBt()" onmousedown="this.style.border='solid 1px #A9A9A9'" onmouseup="this.style.border='solid 0px'">
				</td>
			</tr>
		</table>
	</form>
	<table id="table1" width="100%" border=0  cellpadding=0 cellspacing=1 style="">
		...
		<tr class="tr2" onmouseover="this.style.backgroundColor='#EBEBEB';" onmouseOut="this.style.backgroundColor='';">
			...
			<td align="center">
				<%if("统计负责人".equals(roles)&&"局机关".equals(company)&&"1".equals(tjbbYxzbHsZd.getTjzt())){%>
				<a href="BbsbTjbbServlet?action=TjbbYxzbHsZdReturn&id=<%=tjbbYxzbHsZd.getId()%>&bhry=<%=tjbbYxzbHsZd.getCzrID()%>&company=<%=tjbbYxzbHsZd.getCzrdw()%>"><img  alt="驳回" title="驳回" src="images/small/backbh.png"></a>
			 	<%} %>
				...
				<a href="BbsbTjbbServlet?action=TjbbYxzbHsZdEdit&id=<%=tjbbYxzbHsZd.getId()%>"><img  alt="编辑" title="编辑" src="images/small/options.png"></a>
			 	<%} %>
				...
				<a href="BbsbTjbbServlet?action=TjbbYxzbHsZdDelete&id=<%=tjbbYxzbHsZd.getId()%>" onclick="javascript:return confirm('确定删除此记录？');"><img  alt="删除" title="删除" src="images/small/burn.png"></a>
			 	<%} %>
			</td>
		</tr>
		<%
	...
	<table width="100%" >
		<tr height="35px">
			...
			<td width="50%" align="right">
				站点名称<input type="text" id="zdmc" size="15" value="" >
			</td>
			<td width="50%" align="left">
				<img alt="新增表格" width="100px" height="60px" title="新增表格" style="cursor: pointer;" src="images/small/i13.png"  onclick="insertTjbbYxzbHsZd()" onmousedown="this.style.border='solid 1px #A9A9A9'" onmouseup="this.style.border='solid 0px'">
			</td>
			<%} %>
		</tr>
	</table>
