	...
	<script type="text/javascript">
		 $(document).ready(function() {
	        $('#file_upload').uploadify( {
	            ...
	            'uploader': 'HandleFileServlet?action=MultiFiles&path=StatisticalReports/jjyxfx',//上传所处理的服务器
	            'method': 'post',
	...
	<body>
		...
		<input type="hidden" name="FileUrl" id="FileUrl" <%if(jjyxfx.getFileUrl()!=null){%> value="<%=jjyxfx.getFileUrl()%>"<%}%>>
			<table  width="100%">
				<tr>
					<td align="center">
					名称：<input name="wjmc" id="wjmc" type="text" <%if(jjyxfx.getWjmc()!=null){%>value="<%=jjyxfx.getWjmc() %>"<%}%>/>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					报告时间：<input name="sj" id="sj" type="text" <%if(jjyxfx.getSj()!=null){%>value="<%=jjyxfx.getSj() %>"<%}%> size="10" readonly/>&nbsp;<input name="Button" class="button1" onclick="setDay(document.Jjyxfx.sj);" type="button" value="选择">
					</td>
				</tr>
				<tr>
					<td>
