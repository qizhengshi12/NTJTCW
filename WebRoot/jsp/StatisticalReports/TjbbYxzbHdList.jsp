  ...
  <body>
	...
	<input type=hidden name="username" id="username" value="<%=username%>"/>
		<table width="100%" >
			<tr>
				<td>
					日期：<input name="cxssrq1" id="cxssrq1" type="text" value="<%=cxssrq1%>" size="10" readonly/>&nbsp;<input name="Button" class="button1" onclick="setDay(document.TjbbYxzbHd.cxssrq1);" type="button" value="选择">
					到<input name="cxssrq2" id="cxssrq2" type="text" value="<%=cxssrq2%>" size="10" readonly/>&nbsp;<input name="Button" class="button1" onclick="setDay(document.TjbbYxzbHd.cxssrq2);" type="button" value="选择">
					...
					<img align="middle" width="30px" height="30px" alt="查询" title="查询" style="cursor: pointer;" src="images/small/find.png" onclick="queryTjbbYxzbHdByBt()" onmousedown="this.style.border='solid 1px #A9A9A9'" onmouseup="this.style.border='solid 0px'">
				</td>
			</tr>
		</table>
	</form>
	<table id="table1" width="100%" border=0  cellpadding=0 cellspacing=1 style="">
		...
		<tr class="tr2" onmouseover="this.style.backgroundColor='#EBEBEB';" onmouseOut="this.style.backgroundColor='';">
			...
			<td align="center">
				...
				<%=tjbbYxzbHd.getSj().toString().substring(0,4)%>年<%=tjbbYxzbHd.getSj().toString().substring(5,7)%>月
				<%}else{ %>
				&nbsp;
				<%} %>
			</td>
			...
			<td align="center">
				<%if("统计负责人".equals(roles)&&"局机关".equals(company)&&"1".equals(tjbbYxzbHd.getTjzt())){%>
				<a href="BbsbTjbbServlet?action=TjbbYxzbHdReturn&id=<%=tjbbYxzbHd.getId()%>&bhry=<%=tjbbYxzbHd.getCzrID()%>"><img  alt="驳回" title="驳回" src="images/small/backbh.png"></a>
			 	<%} %>
				...
				<a href="BbsbTjbbServlet?action=TjbbYxzbHdEdit&id=<%=tjbbYxzbHd.getId()%>&xzrq=<%=tjbbYxzbHd.getSj()%>"><img  alt="编辑" title="编辑" src="images/small/options.png"></a>
			 	<%} %>
				...
				<a href="BbsbTjbbServlet?action=TjbbYxzbHdDelete&id=<%=tjbbYxzbHd.getId()%>" onclick="javascript:return confirm('确定删除此记录？');"><img  alt="删除" title="删除" src="images/small/burn.png"></a>
			 	<%} %>
			</td>
		</tr>
		<%
	...
	<table width="100%" >
		<tr height="35px">
			...
			<td align="left" width="50%">
				<img alt="新增表格" width="100px" height="60px" title="新增表格" style="cursor: pointer;" src="images/small/i13.png"  onclick="insertTjbbYxzbHd()" onmousedown="this.style.border='solid 1px #A9A9A9'" onmouseup="this.style.border='solid 0px'">
			</td>
			<%} %>
		</tr>
	</table>
