	...
	<body>
		...
		<!--startprint1-->
			<table  width="100%">
				<tr>
					<td>
						<strong>标题：</strong><span><%=Gfxwj.getBt()%></span>
					</td>
					<td width="250px">
						<strong>文号：</strong><span><%=Gfxwj.getWh()%></span>
					</td>
				</tr>
				<tr>
					<td>
						<strong>实施日期：</strong><span><%=Gfxwj.getSsrq()%></span>
					</td>
					<td>
						<strong>发布单位：</strong><span><%=Gfxwj.getFbdw()%></span>
					</td>
				</tr>
				<tr>
					<td colspan="2">
				...
				<tr>
					...
					<span style="font-size: 25px;font-weight: bold;font-stretch: "><%=Gfxwj.getBt()%></span>
					</td>
				</tr>
				<tr>
