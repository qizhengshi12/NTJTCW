...
<html>
   ...
   <LINK href="cwbasic.css" type="text/css" rel="stylesheet">
    <script language="javascript">
    	function queryMenuContext(MenuId){
			...
			form.action = "FlServlet?action=query&MenuId=" + MenuId;
			form.submit();
    	} 
    	function queryContextByBt(){
    		...
    		var form = document.getElementById("form1");
			form.action = "FlServlet?action=query&srbt=" + srbt+"&MenuId=";
			form.submit();
    	} 
		...
		function insertFatherDode(){
			...
			form.action = "FlServlet?action=insertMenu&ParentID=0&name=" + name;
			form.submit();
		} 
		//添加子菜单
		...
		function insertSonDode(){
			...
			var form = document.getElementById("form2");
			form.action = "FlServlet?action=insertMenu&ParentID=" + id+"&name=" + name;
			form.submit();
		}   	
    	//编辑菜单项
		...
		function insertEditDode(){
			...
			var form = document.getElementById("form2");
			form.action = "FlServlet?action=updateMenu&id=" + id+"&name=" + name;
			form.submit();
		}
    	...
    	function deleteDode(){
    		...
    		var form = document.getElementById("form2");
			form.action = "FlServlet?action=deleteMenu&id=" + id;
			form.submit();
		}	
    	//新增文件
    	function insertDode(){
    		...
    		var form = document.getElementById("form2");
			form.action = "jsp/LawInformation/flInsert.jsp?fatherid="+id;
			form.submit();
		}
		function selChange1(){
  ...
  <form method="post" name="Fl" id="form1" action="" target="content">
			...
			<td width="85%" valign="top">	
				<table width="100%">
					...
					<tr>
						...
						<td align="left" colspan="3">   
							实施日期：<input name="cxssrq1" id="cxssrq1" type="text" value="" size="10" readonly/><input name="Button" class="button1" onclick="setDay(document.Fl.cxssrq1);" type="button" value="选择">
							到
							<input name="cxssrq2" id="cxssrq2" type="text" value="" size="10" readonly/><input name="Button" class="button1" onclick="setDay(document.Fl.cxssrq2);" type="button" value="选择">
