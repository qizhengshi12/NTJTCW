	...
	<table id="table1" width="100%" border=0  cellpadding=0 cellspacing=1>
		...
		<tr class="tr2" onmouseover="this.style.backgroundColor='#EBEBEB';" onmouseOut="this.style.backgroundColor='';">
			...
			<td align="center">
				...
				<a href="GzServlet?action=editGz&id=<%=contentGz.getId()%>"><img  alt="编辑" title="编辑" src="images/small/options.png"></a>
				<%} %>
				<%if(UserPer.getContentcjfg().indexOf("4")!=-1){%>
				<a href="GzServlet?action=delete&id=<%=contentGz.getId()%>&fatherid=<%=contentGz.getFatherid()%>&path=<%=contentGz.getFileUrl()%>" onclick="javascript:return confirm('确定删除此记录？');"><img  alt="删除" title="删除" src="images/small/burn.png"></a>
				<%} %>
			</td>
			<%} %>
		</tr>
