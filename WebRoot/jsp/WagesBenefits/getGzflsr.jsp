  ...
  <head>
   ...
   <script src="calendar.js"></script>
	...
	<script type="text/javascript">
    	...
    	<% if(UserPer.getGzfl().indexOf("5")!=-1){ %>
    		document.getElementById("cxcompany").value = val;
    	<% } %>
			var cxcompany = document.getElementById("cxcompany").value;
        	var form = document.getElementById("form1");
			form.action = "GzflsrServlet?action=getGzflsrList&flag=1&cxcompany="+cxcompany;
			form.submit();
    	}
    	//重置菜单
		function resetMenu(){
			var form = document.getElementById("form2");
			form.action = "GzflsrServlet?action=resetMenu";
			form.submit();
		}
		
	   	function queryGzflsrByBt(){
			...
			var srbt = "";
	   		...
	   		var form = document.getElementById("form1");
			form.action = "GzflsrServlet?action=getGzflsrList&srbt=" + srbt;
			form.submit();
	   	}
	    function insertGzflsr(){
	   		var form = document.getElementById("form2");
			form.action = "GzflsrServlet?action=gzflsrEdit";
			form.submit();
	    }
		function selChange3(){
			  ...
			  <table width="100%">
				<tr>
					<td align="center">
						...
						<img align="middle" width="30px" height="30px" alt="查询" title="查询" style="cursor: pointer;" src="images/small/find.png" onclick="queryGzflsrByBt()" onmousedown="this.style.border='solid 1px #A9A9A9'" onmouseup="this.style.border='solid 0px'">
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr height="35px" valign="bottom">
					<td align="center">
						<%if(UserPer.getGzfl().indexOf("2")!=-1){%>
						<img alt="新增表格" width="100px" height="60px" title="新增表格" style="cursor: pointer;" src="images/small/i13.png"  onclick="insertGzflsr()" onmousedown="this.style.border='solid 1px #A9A9A9'" onmouseup="this.style.border='solid 0px'">
						<%} %>
					</td>
				</tr>
			  </table>
