	  ...
	  <table width="100%">
		<tr>
			<td align="left" colspan="2">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<img  alt="选中" align="middle" src="images/small/favorites.png"><a href='EmailServlet?action=AllSendEmail&flag=1'><span style="font-size: 16px;border:1px; background:#C1FFB2;">发件箱</span></a>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <form method="post" id="form2" action=""></form>
	<table id="table1" width="100%" border=0  cellpadding=0 cellspacing=1 style="">
		...
		<tr class="tr2" onmouseover="this.style.backgroundColor='#EBEBEB';" onmouseOut="this.style.backgroundColor='';">
			...
			<td align="center">
				<a href="EmailServlet?action=deleteSendEmail&ly=1&id=<%=myMessage.getId()%>" onclick="javascript:return confirm('确定删除此记录？');"><img  alt="删除" title="删除" src="images/small/burn.png"></a>
			 </td>
		</tr>
		<%
		}
