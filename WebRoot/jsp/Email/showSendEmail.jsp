...
<html>
  ...
  <body>
	...
	<table width="100%">
		...
		<tr>
			<td align="left">
			密送人：<%=sendEmail.getMsr()%>
			</td>
			<td>
			日&nbsp;&nbsp;期：<%=sendEmail.getCzsj().toString().substring(0,19)%>
			</td>
		</tr>
		<tr >
			<td colspan="2">
	...
	<table  width="100%">
		<tr>
			<td align="center">
				<img width="100px" height="60px" alt="转发" title="转发" style="cursor: pointer;" src="images/small/i20.png" onclick="EditEmail(3,'<%=sendEmail.getId()%>');" onmousedown="this.style.border='solid 1px #A9A9A9'" onmouseup="this.style.border='solid 0px'">
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
