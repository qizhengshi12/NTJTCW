		...
		<!--startprint1-->
			<table width="1300px" align="center">
				<tr>
					...
					市级机关（含下属事业单位）落实收费政策季度自查表（<%= sjbbLssfzcHzb.getYear() %>年<% if(sjbbLssfzcHzb.getJd()==0){ %><%}else{%><%=sjbbLssfzcHzb.getJd() %>季度<%}%>）
					</td>
				</tr>
				<tr >
					<td colspan="2">
				...
				<tr>
					...
					<td align="right">
					报送时间：<%=sjbbLssfzcHzb.getCzsj().toString().substring(0,10)%>
					</td>
				</tr>
			</table>
			...
			<table width="100%" align="center">
				...
				<tr>
					<td>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;填表人：<%=sjbbLssfzcHzb.getCzr()%>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						联系电话：<%=sjbbLssfzcHzb.getCzrphone()%>
					</td>
				</tr>
			</table>
