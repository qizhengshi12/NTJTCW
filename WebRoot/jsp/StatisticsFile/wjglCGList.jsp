...
<html>
   ...
   img {border:0px;}
    ...
    <script type="text/javascript">
   	function queryWjglByBt(){
		...
		form.action = "WjglServlet?action=getWjglCGList&srbt=" + srbt;
		form.submit();
   	}
	function selChange1(){
	...
	function skipTo(v){
		...
		form.action = "WjglServlet?action=getWjglCGList&srbt="+srbt+"&page_no=" + v;
		form.submit();
	}
    </script>
  </head>
  ...
  <form method="post" id="form2" name="WJGL">
	...
	<table width="100%" >
		...
		<tr>
			<td>
				<img  alt="选中" align="top" src="images/small/favorites.png"><a href='WjglServlet?action=getWjglCGList&flag=1'><span style="font-size: 16px;border:1px; background:#D1EEEE;">草稿箱文件列表</span></a>
			</td>
		</tr>
		<tr>
			<td colspan="2">
	...
	<table id="table1" width="100%" border=0  cellpadding=0 cellspacing=1 style="">
		...
		<tr class="tr2" onmouseover="this.style.backgroundColor='#EBEBEB';" onmouseOut="this.style.backgroundColor='';">
			...
			<td align="center">
				<a href="WjglServlet?action=editWjglCG&id=<%=wjglxf.getId()%>"><img  alt="编辑" title="编辑" src="images/small/options.png"></a>
