	...
	<body>
		...
		<input type="hidden" name="fszt" id="fszt" value="">
			<table  width="100%">
				<tr>
					<td>
					文件名称：<input name="wjmc" id="wjmc" type="text" value=""/>
					文件类型：
					...
					发文号：<input name="wjh" id="wjh" type="text" value=""/>
					</td>
				</tr>
				<tr>
					<td>
		...
		<table  width="100%">
			<tr>
				<td align="center">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<img alt="取消" width="45px" height="45px" title="取消" style="cursor: pointer;"  src="images/small/undo.png" onclick="cancelthis()" onmousedown="this.style.border='solid 1px #A9A9A9'" onmouseup="this.style.border='solid 0px'">
				</td>
			</tr>
		</table>
	</body>
