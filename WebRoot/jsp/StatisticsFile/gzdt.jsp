...
<html>
  <head>
   ...
   <LINK href="cwbasic.css" type="text/css" rel="stylesheet">
    <script language="javascript">
    	...
    	<% if(UserPer.getGzdt().indexOf("5")!=-1){ %>
    	...
    	<% } %>
			...
			form.action = "GzdtServlet?action=query&srbt=" + srbt;
			form.submit();
    	} 
		...
		function resetMenu(){
			...
			form.action = "GzdtServlet?action=resetMenu";
			form.submit();
		}
    	//新增文件
    	function insertDode(dw){
    		var form = document.getElementById("form2");
			form.action = "GzdtServlet?action=gzdtEdit";
			form.submit();
		}
		function selChange3(){
  ...
  <form method="post" id="form1" name="Gzdt" action="" target="content">
		...
		<tr>
			...
			<td width="85%" valign="top">	
				<table width="100%">
					...
					<tr>
						<td width="100%" align="left">
							提交日期：<input name="cxssrq1" id="cxssrq1" type="text" value="" size="10" readonly/>&nbsp;<input name="Button" class="button1" onclick="setDay(document.Gzdt.cxssrq1);" type="button" value="选择">
							到<input name="cxssrq2" id="cxssrq2" type="text" value="" size="10" readonly/>&nbsp;<input name="Button" class="button1" onclick="setDay(document.Gzdt.cxssrq2);" type="button" value="选择">
							...
							<%if(UserPer.getGzdt().indexOf("1")!=-1){%>
					...
					<tr height="35px">
						<td align="center">
							<%if(UserPer.getGzdt().indexOf("2")!=-1){%>
