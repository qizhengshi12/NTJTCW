...
<html>
  ...
  <form method="post" id="form2" name="WJGL">
	...
	<table width="100%" >
		<tr>
			<td width="20%">
				<img  alt="选中" align="top" src="images/small/favorites.png"><a href='WjglServlet?action=getWjglList&flag=1'><span style="font-size: 16px;border:1px; background:#C1FFB2;">所有文件列表</span></a>
			</td>
			<td width="80%" align="left" rowspan="2">
				...
				发布单位：<input type="text" name="cxcompany" id="cxcompany" onclick="CXCompany()" value="<%=cxcompany %>" readonly="readonly" class="STYLE1"/><span id="suggest1"></span>
			</td>
		</tr>
		<tr>
			<td>
	...
	<table id="table1" width="100%" border=0  cellpadding=0 cellspacing=1 style="">
		<tr class="tr1">
			...
			<%if("财务负责人".equals(roles)&&"局机关".equals(company)){%>
			<td align="center" width="10%" class="STYLE1">
				操作
			</td>
			<%} %>
		...
		<tr class="tr2" onmouseover="this.style.backgroundColor='#EBEBEB';" onmouseOut="this.style.backgroundColor='';">
			...
			<td align="center">
				...
				<%}%>
  					<a href="WjglServlet?action=deleteWjglXF&id=<%=wjglxf.getId() %>&FileUrl=<%=wjglxf.getFileUrl()%>&address=1" onclick="javascript:return confirm('确定删除此记录？');"><img  alt="删除" title="删除" src="images/small/burn.png"></a>
