	...
	<script type="text/javascript">
		function getExcel(){
			if(confirm("确定导出本表单的Excel么？")){
				...
				form.action = "BbsbCwbbServlet?action=getCwbbZcfzbJCZXExcel";
				form.submit();
			} 
		}
		function cancel(){
		...
		<!--startprint1-->
			...
			<table id="table2" width="81%" align="center" border=1  cellpadding=0 cellspacing=0 style="">
				<tr>
					...
					<td align="center" width="13%" class="STYLE6">期末余额
					</td>
					<td align="center" width="13%" class="STYLE6">年初余额
					</td>
					<td align="center" width="20%" class="STYLE6">负债和所有者权益
					</td>
					<td align="center" width="4%" class="STYLE6">行次
					</td>
					<td align="center" width="13%" class="STYLE6">期末余额
