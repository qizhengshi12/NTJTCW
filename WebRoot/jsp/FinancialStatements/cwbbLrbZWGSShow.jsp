...
<html>
  <head>
    ...
    <title>利润表（站务公司）</title>
    <script src="calendar.js"></script>
	<script type="text/javascript">
		function getExcel(){
			if(confirm("确定导出下列表单的Excel么？")){
				var form = document.getElementById("form1");
				form.action = "BbsbCwbbServlet?action=getCwbbLrbZWGSExcel";
				form.submit();
			} 
		}
		function cancel(){
	...
	<% } %>
		...
		<table id="table2" width="81%" align="center" border=1  cellpadding=0 cellspacing=0 style="">
			<tr>
				<td align="center" width="50%" height="30px">项&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;目
				</td>
			...
			<tr>
				<td align="left" height="30px">一、主营业务收入
				</td>
				<td align="center">1
				</td>
				<td align="right">
			...
			<tr>
				<td align="left" height="30px">&nbsp;减：主营业务成本
				</td>
				<td align="center">2
				</td>
				<td align="right">
			...
			<tr>
				<td align="left" height="30px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;主营业务税金及附加
				</td>
				<td align="center">3
				</td>
				<td align="right">
			...
			<tr>
				<td align="left" height="30px">二、主营业务利润（亏损以“-”号填列）
				</td>
				<td align="center">4
				</td>
				<td align="right">
			...
			<tr>
				<td align="left" height="30px">&nbsp;加：其他业务利润（亏损以“-”号填列）
				</td>
				<td align="center">5
				</td>
				<td align="right">
			...
			<tr>
				<td align="left" height="30px">&nbsp;减：营业费用
				</td>
				<td align="center">6
				</td>
				<td align="right">
			...
			<tr>
				<td align="left" height="30px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;管理费用
				</td>
				<td align="center">7
				</td>
				<td align="right">
			...
			<tr>
				<td align="left" height="30px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;财务费用
				</td>
				<td align="center">8
				</td>
				<td align="right">
			...
			<tr>
				<td align="left" height="30px">三、营业利润（亏损以“-”号填列）
				</td>
				<td align="center">9
				</td>
				<td align="right">
			...
			<tr>
				<td align="left" height="30px">&nbsp;加：投资收益（损失以“-”号填列）
				</td>
				<td align="center">10
				</td>
				<td align="right">
			...
			<tr>
				<td align="left" height="30px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;补贴收入
				</td>
				<td align="center">11
				</td>
				<td align="right">
			...
			<tr>
				<td align="left" height="30px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;营业外收入
				</td>
				<td align="center">12
				</td>
				<td align="right">
			...
			<tr>
				<td align="left" height="30px">&nbsp;减：营业外支出
				</td>
				<td align="center">13
				</td>
				<td align="right">
			...
			<tr>
				<td align="left" height="30px">四、利润总额（亏损总额以“-”号填列）
				</td>
				<td align="center">14
				</td>
				<td align="right">
			...
			<tr>
				<td align="left" height="30px">&nbsp;减：所得税
				</td>
				<td align="center">15
				</td>
				<td align="right">
			...
			<tr>
				<td align="left" height="30px">五、净利润（净亏损以“-”号填列）
				</td>
				<td align="center">16
				</td>
				<td align="right">
		...
		<table id="table2" width="81%" align="center" border=1  cellpadding=0 cellspacing=0 style="">
			...
			<tr>
				<td align="left" height="30px">1、出售、处置部门或被投资单位所得收益
				</td>
				<td align="right">
			...
			<tr>
				<td align="left" height="30px">2、自然灾害发生的损失
				</td>
				<td align="right">
			...
			<tr>
				<td align="left" height="30px">3、会计政策变更增加（或减少）利润总额
				</td>
				<td align="right">
			...
			<tr>
				<td align="left" height="30px">4、会计估计变更增加（或减少）利润总额
				</td>
				<td align="right">
			...
			<tr>
				<td align="left" height="30px">5、债务重组损失
				</td>
				<td align="right">
			...
			<tr>
				<td align="left" height="30px">6、其他
				</td>
				<td align="right">
