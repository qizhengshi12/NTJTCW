  ...
  <body>
		...
		<table width="100%" >
			<tr>
				<td>
					...
					<img align="middle" width="30px" height="30px" alt="查询" title="查询" style="cursor: pointer;" src="images/small/find.png" onclick="queryCwbbYszxbByBt()" onmousedown="this.style.border='solid 1px #A9A9A9'" onmouseup="this.style.border='solid 0px'">
				</td>
			</tr>
		</table>
	</form>
	<table id="table1" width="100%" border=0  cellpadding=0 cellspacing=1 style="">
		...
		<tr class="tr2" onmouseover="this.style.backgroundColor='#EBEBEB';" onmouseOut="this.style.backgroundColor='';">
			...
			<td align="center">
				<%if(("财务负责人".equals(roles)||"信息员".equals(roles))&&"局机关".equals(company)&&"1".equals(cwbbYszxb.getTjzt())){%>
				<a href="BbsbCwbbServlet?action=yszxbReturn&id=<%=cwbbYszxb.getId()%>&bhry=<%=cwbbYszxb.getCzrID()%>"><img  alt="驳回" title="驳回" src="images/small/backbh.png"></a>
			 	<%} %>
				<%if(username.equals(cwbbYszxb.getCzrID())&&("2".equals(cwbbYszxb.getTjzt())||"3".equals(cwbbYszxb.getTjzt()))&&UserPer.getCwbb().indexOf("3")!=-1){%>
				<a href="BbsbCwbbServlet?action=yszxbEdit&id=<%=cwbbYszxb.getId()%>"><img  alt="编辑" title="编辑" src="images/small/options.png"></a>
			 	<%} %>
				<%if(username.equals(cwbbYszxb.getCzrID())&&("2".equals(cwbbYszxb.getTjzt())||"3".equals(cwbbYszxb.getTjzt()))&&UserPer.getCwbb().indexOf("4")!=-1){%>
				<a href="BbsbCwbbServlet?action=yszxbDelete&id=<%=cwbbYszxb.getId()%>&xmid=<%=cwbbYszxb.getXmid()%>" onclick="javascript:return confirm('确定删除此记录？');"><img  alt="删除" title="删除" src="images/small/burn.png"></a>
			 	<%} %>
			</td>
		</tr>
		<%
	...
	<table width="100%" >
		<tr>
			...
			<img alt="新增表格" width="100px" height="60px" title="新增表格" style="cursor: pointer;" src="images/small/i13.png"  onclick="insertCwbbYszxb()" onmousedown="this.style.border='solid 1px #A9A9A9'" onmouseup="this.style.border='solid 0px'">
			</td>
			<%} %>
		</tr>
	</table>
