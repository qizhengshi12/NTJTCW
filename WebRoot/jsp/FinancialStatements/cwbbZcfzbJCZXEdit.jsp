  ...
  <head>
	...
	<script type="text/javascript">
        ...
        function verification(){
        	...
        	qms1[16].value="";
        	//资产年初数
        	ncs1[15].value = (Number(ncs1[1].value)+Number(ncs1[2].value)+Number(ncs1[3].value)+Number(ncs1[4].value)+Number(ncs1[5].value)+Number(ncs1[6].value)+Number(ncs1[7].value)+Number(ncs1[8].value)+Number(ncs1[9].value)+Number(ncs1[14].value)).toFixed(2);
        	ncs1[21].value = (Number(ncs1[19].value)-Number(ncs1[20].value)).toFixed(2);
        	ncs1[30].value = (Number(ncs1[17].value)+Number(ncs1[18].value)+Number(ncs1[21].value)+Number(ncs1[22].value)+Number(ncs1[23].value)+Number(ncs1[24].value)+Number(ncs1[25].value)+Number(ncs1[26].value)+Number(ncs1[27].value)+Number(ncs1[28].value)+Number(ncs1[29].value)).toFixed(2);
        	ncs1[31].value = (Number(ncs1[15].value)+Number(ncs1[30].value)).toFixed(2);
        	//资产期末数
        	qms1[15].value = (Number(qms1[1].value)+Number(qms1[2].value)+Number(qms1[3].value)+Number(qms1[4].value)+Number(qms1[5].value)+Number(qms1[6].value)+Number(qms1[7].value)+Number(qms1[8].value)+Number(qms1[9].value)+Number(qms1[14].value)).toFixed(2);
        	qms1[21].value = (Number(qms1[19].value)-Number(qms1[20].value)).toFixed(2);
        	qms1[30].value = (Number(qms1[17].value)+Number(qms1[18].value)+Number(qms1[21].value)+Number(qms1[22].value)+Number(qms1[23].value)+Number(qms1[24].value)+Number(qms1[25].value)+Number(qms1[26].value)+Number(qms1[27].value)+Number(qms1[28].value)+Number(qms1[29].value)).toFixed(2);
        	qms1[31].value = (Number(qms1[15].value)+Number(qms1[30].value)).toFixed(2);
        	//加逗号
        	...
        	qms2[25].value="";
        	//负债年初数
        	ncs2[11].value = (Number(ncs2[1].value)+Number(ncs2[2].value)+Number(ncs2[3].value)+Number(ncs2[4].value)+Number(ncs2[5].value)+Number(ncs2[6].value)+Number(ncs2[7].value)+Number(ncs2[8].value)+Number(ncs2[9].value)+Number(ncs2[10].value)).toFixed(2);
        	ncs2[17].value = (Number(ncs2[13].value)+Number(ncs2[14].value)+Number(ncs2[15].value)+Number(ncs2[16].value)).toFixed(2);
        	ncs2[18].value = (Number(ncs2[11].value)+Number(ncs2[17].value)).toFixed(2);
        	ncs2[30].value = (Number(ncs2[26].value)+Number(ncs2[27].value)+Number(ncs2[28].value)+Number(ncs2[29].value)).toFixed(2);
        	ncs2[31].value = (Number(ncs2[18].value)+Number(ncs2[30].value)).toFixed(2);
        	//负债期末数
        	qms2[11].value = (Number(qms2[1].value)+Number(qms2[2].value)+Number(qms2[3].value)+Number(qms2[4].value)+Number(qms2[5].value)+Number(qms2[6].value)+Number(qms2[7].value)+Number(qms2[8].value)+Number(qms2[9].value)+Number(qms2[10].value)).toFixed(2);
        	qms2[17].value = (Number(qms2[13].value)+Number(qms2[14].value)+Number(qms2[15].value)+Number(qms2[16].value)).toFixed(2);
        	qms2[18].value = (Number(qms2[11].value)+Number(qms2[17].value)).toFixed(2);
        	qms2[30].value = (Number(qms2[26].value)+Number(qms2[27].value)+Number(qms2[28].value)+Number(qms2[29].value)).toFixed(2);
        	qms2[31].value = (Number(qms2[18].value)+Number(qms2[30].value)).toFixed(2);
        	//加逗号
        	for(var l=0;l<ncs2.length;l++){
         		ncs2[l].value = addCommas2(ncs2[l].value);
         		qms2[l].value = addCommas2(qms2[l].value);
        	}
        	if(ncs1[31].value!=ncs2[31].value){
        		ncs1[31].style.color='red';
        		ncs2[31].style.color='red';
        		return 1;
        	}else{
        		ncs1[31].style.color='black';
        		ncs2[31].style.color='black';
        	}
        	if(qms1[31].value!=qms2[31].value){
        		qms1[31].style.color='red';
        		qms2[31].style.color='red';
        		return 1;
        	}else{
        		qms1[31].style.color='black';
        		qms2[31].style.color='black';
        	}
        }
        function cancel(){
	    ...
	    function callback(msg){
	       	if(msg!='1'){
        		var form = document.getElementById("form1");
				form.action = "BbsbCwbbServlet?action=readZcfzbJCZXExcel&URL="+msg;
				form.submit();
	       	}else{
	       		alert("上传冲突，请稍后再试");
	       		return;
		...
		<input name="tjzt" id="tjzt" type="hidden" value=""/>
			...
			<table id="table2" width="100%" border=1  cellpadding=0 cellspacing=0 style="">
				<tr>
					...
					<td align="center" width="15%">年初余额
					</td>
					<td align="center" width="15%">负债和所有者权益
					</td>
					<td align="center" width="5%">行次
					</td>
					<td align="center" width="15%">期末余额
				...
				<tr>
					...
					<td align="left">应付利润
					<input name="mc2" type="hidden" value="应付利润"/>
					</td>
					<td align="center">38
				...
				<tr>
					<td align="left">在产品
					<input name="mc1" type="hidden" value="在产品"/>
					</td>
					<td align="center">11
					...
					<td align="center">
					<input name="qms2" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbfzList.size()!=0){%>value="<%=CwbbZcfzbfzList.get(11).getQms()%>"<%}%>/>
					</td>
					<td align="center">
					<input name="ncs2" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbfzList.size()!=0){%>value="<%=CwbbZcfzbfzList.get(11).getNcs()%>"<%}%>/>
					</td>
				</tr>
				<tr>
					<td align="left">库存商品
					<input name="mc1" type="hidden" value="库存商品"/>
					</td>
					<td align="center">12
				...
				<tr>
					<td align="left">周转材料
					<input name="mc1" type="hidden" value="周转材料"/>
					</td>
					<td align="center">13
				...
				<tr>
					<td align="left">长期债券投资
					<input name="mc1" type="hidden" value="长期债券投资"/>
					</td>
					<td align="center">16
				...
				<tr>
					...
					<td align="center">
					<input name="qms2" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbfzList.size()!=0){%>value="<%=CwbbZcfzbfzList.get(18).getQms()%>"<%}%>/>
					</td>
					<td align="center">
					<input name="ncs2" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbfzList.size()!=0){%>value="<%=CwbbZcfzbfzList.get(18).getNcs()%>"<%}%>/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td align="left">固定资产账面价值
					<input name="mc1" type="hidden" value="固定资产账面价值"/>
					</td>
					<td align="center">20
				...
				<tr>
					<td align="left">非流动资产总计
					<input name="mc1" type="hidden" value="非流动资产总计"/>
					</td>
					<td align="center">29
					<input name="hc1" type="hidden" value="29"/>
					</td>
					<td align="center">
					<input name="qms1" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbzcList.size()!=0){%>value="<%=CwbbZcfzbzcList.get(30).getQms()%>"<%}%>/>
					</td>
					<td align="center">
					<input name="ncs1" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbzcList.size()!=0){%>value="<%=CwbbZcfzbzcList.get(30).getNcs()%>"<%}%>/>
					</td>
				...
				<tr>
					...
					<td align="center">
					<input name="qms1" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbzcList.size()!=0){%>value="<%=CwbbZcfzbzcList.get(31).getQms()%>"<%}%>/>
					</td>
					<td align="center">
					<input name="ncs1" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbzcList.size()!=0){%>value="<%=CwbbZcfzbzcList.get(31).getNcs()%>"<%}%>/>
					</td>
					<td align="left">负债和所有者权益（或股东权益）合计
					<input name="mc2" type="hidden" value="负债和所有者权益（或股东权益）合计"/>
					</td>
					<td align="center">53
					<input name="hc2" type="hidden" value="53"/>
					</td>
					<td align="center">
					<input name="qms2" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbfzList.size()!=0){%>value="<%=CwbbZcfzbfzList.get(31).getQms()%>"<%}%>/>
					</td>
					<td align="center">
					<input name="ncs2" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbfzList.size()!=0){%>value="<%=CwbbZcfzbfzList.get(31).getNcs()%>"<%}%>/>
					</td>
				</tr>
			</table>
		</form>
