	...
	<script type="text/javascript">
		function getExcel(){
			if(confirm("确定导出本表单的Excel么？")){
				...
				form.action = "BbsbCwbbServlet?action=getCwbbZcfzbCZGSExcel";
				form.submit();
			} 
		}
		function cancel(){
		...
		<!--startprint1-->
			...
			<table id="table2" width="81%" align="center" border=1  cellpadding=0 cellspacing=0 style="">
				<tr>
					...
					<td align="center" width="20%" class="STYLE6">负债及所有者权益
					</td>
					<td align="center" width="4%" class="STYLE6">行次
					</td>
					<td align="center" width="13%" class="STYLE6">年初数
				...
				<%for(int i=0; i<CwbbZcfzbzcList.size()-1; i++){
				%>
				<tr>
			...
			<table  width="81%" align="center">
				<tr>
					<td align="left">补充资料：1.已贴现的商业承兑汇票<%=CwbbZcfzbzcList.get(CwbbZcfzbzcList.size()-1).getHc()%>元；
					</td>
				</tr>
				<tr>
					<td align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2.融资租入固定资产原价<%=CwbbZcfzbzcList.get(CwbbZcfzbzcList.size()-1).getQms()%>元。
					</td>
				</tr>
			</table>
			<!--endprint1-->
