  ...
  <head>
	...
	<script type="text/javascript">
        ...
        function verification(){
        	...
        	bys[7].value = (Number(bys[3].value)+Number(bys[4].value)-Number(bys[5].value)-Number(bys[6].value)).toFixed(2);
        	bys[12].value = (Number(bys[7].value)+Number(bys[8].value)+Number(bys[9].value)-Number(bys[10].value)+Number(bys[11].value)).toFixed(2);
        	bys[14].value = (Number(bys[12].value)-Number(bys[13].value)).toFixed(2);
        	//本年累计数
        	bnljs[3].value = (Number(bnljs[0].value)-Number(bnljs[1].value)-Number(bnljs[2].value)).toFixed(2);
        	bnljs[7].value = (Number(bnljs[3].value)+Number(bnljs[4].value)-Number(bnljs[5].value)-Number(bnljs[6].value)).toFixed(2);
        	bnljs[12].value = (Number(bnljs[7].value)+Number(bnljs[8].value)+Number(bnljs[9].value)-Number(bnljs[10].value)+Number(bnljs[11].value)).toFixed(2);
        	bnljs[14].value = (Number(bnljs[12].value)-Number(bnljs[13].value)).toFixed(2);
        	//加逗号
	    ...
	    function callback(msg){
	       	if(msg!='1'){
        		var form = document.getElementById("form1");
				form.action = "BbsbCwbbServlet?action=readLrbCZGSExcel&URL="+msg;
				form.submit();
	       	}else{
	       		alert("上传冲突，请稍后再试");
	       		return;
		...
		<input type="hidden" name="hzbz" id="hzbz" value="CZGS" >
			...
			<table id="table2" width="100%" border=1  cellpadding=0 cellspacing=0 style="">
				...
				<tr>
					...
					<td align="center">
					<input name="bys" type="text" size="15" onblur="this.value=addCommas(this.value)"  readonly="readonly" <%if(CwbbLrbsjList.size()!=0){%>value="<%=CwbbLrbsjList.get(7).getBys()%>"<%}%>/>
					</td>
					<td align="center">
					<input name="bnljs" type="text" size="15" onblur="this.value=addCommas(this.value)" readonly="readonly" <%if(CwbbLrbsjList.size()!=0){%>value="<%=CwbbLrbsjList.get(7).getBnljs()%>"<%}%>/>
					<input name="sntqs" type="hidden"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="center">
					<input name="bys" type="text" size="15" onblur="this.value=addCommas(this.value)"  readonly="readonly" <%if(CwbbLrbsjList.size()!=0){%>value="<%=CwbbLrbsjList.get(12).getBys()%>"<%}%>/>
					</td>
					<td align="center">
					<input name="bnljs" type="text" size="15" onblur="this.value=addCommas(this.value)" readonly="readonly" <%if(CwbbLrbsjList.size()!=0){%>value="<%=CwbbLrbsjList.get(12).getBnljs()%>"<%}%>/>
					<input name="sntqs" type="hidden"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="center">
					<input name="bys" type="text" size="15" onblur="this.value=addCommas(this.value)"  readonly="readonly" <%if(CwbbLrbsjList.size()!=0){%>value="<%=CwbbLrbsjList.get(14).getBys()%>"<%}%>/>
					</td>
					<td align="center">
					<input name="bnljs" type="text" size="15" onblur="this.value=addCommas(this.value)" readonly="readonly" <%if(CwbbLrbsjList.size()!=0){%>value="<%=CwbbLrbsjList.get(14).getBnljs()%>"<%}%>/>
					<input name="sntqs" type="hidden"/>
					</td>
				</tr>
			</table>
