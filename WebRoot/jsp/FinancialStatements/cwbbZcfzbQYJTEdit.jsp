  ...
  <head>
	...
	<script type="text/javascript">
        ...
        function verification(){
        	...
        	qms1[38].value="";
        	//资产年初数
        	ncs1[8].value = (Number(ncs1[6].value)-Number(ncs1[7].value)).toFixed(2);
        	ncs1[14].value = (Number(ncs1[1].value)+Number(ncs1[2].value)+Number(ncs1[3].value)+Number(ncs1[4].value)+Number(ncs1[5].value)+Number(ncs1[8].value)+Number(ncs1[9].value)+Number(ncs1[10].value)+Number(ncs1[11].value)+Number(ncs1[12].value)+Number(ncs1[13].value)).toFixed(2);
        	...
        	ncs1[32].value = (Number(ncs1[28].value)+Number(ncs1[29].value)+Number(ncs1[30].value)+Number(ncs1[31].value)).toFixed(2);
        	ncs1[37].value = (Number(ncs1[34].value)+Number(ncs1[35].value)+Number(ncs1[36].value)).toFixed(2);
        	ncs1[40].value = (Number(ncs1[14].value)+Number(ncs1[16].value)+Number(ncs1[17].value)+Number(ncs1[18].value)+Number(ncs1[22].value)+Number(ncs1[32].value)+Number(ncs1[37].value)+Number(ncs1[39].value)).toFixed(2);
        	//资产期末数
        	qms1[8].value = (Number(qms1[6].value)-Number(qms1[7].value)).toFixed(2);
        	qms1[14].value = (Number(qms1[1].value)+Number(qms1[2].value)+Number(qms1[3].value)+Number(qms1[4].value)+Number(qms1[5].value)+Number(qms1[8].value)+Number(qms1[9].value)+Number(qms1[10].value)+Number(qms1[11].value)+Number(qms1[12].value)+Number(qms1[13].value)).toFixed(2);
        	...
        	qms1[32].value = (Number(qms1[28].value)+Number(qms1[29].value)+Number(qms1[30].value)+Number(qms1[31].value)).toFixed(2);
        	qms1[37].value = (Number(qms1[34].value)+Number(qms1[35].value)+Number(qms1[36].value)).toFixed(2);
        	qms1[40].value = (Number(qms1[14].value)+Number(qms1[16].value)+Number(qms1[17].value)+Number(qms1[18].value)+Number(qms1[22].value)+Number(qms1[32].value)+Number(qms1[37].value)+Number(qms1[39].value)).toFixed(2);
        	//加逗号
        	...
        	qms2[35].value="";
        	//负债年初数
        	ncs2[14].value = (Number(ncs2[1].value)+Number(ncs2[2].value)+Number(ncs2[3].value)+Number(ncs2[4].value)+Number(ncs2[5].value)+Number(ncs2[6].value)+Number(ncs2[7].value)+Number(ncs2[8].value)+Number(ncs2[9].value)+Number(ncs2[10].value)+Number(ncs2[12].value)+Number(ncs2[13].value)).toFixed(2);
        	ncs2[23].value = (Number(ncs2[16].value)+Number(ncs2[17].value)+Number(ncs2[18].value)+Number(ncs2[19].value)+Number(ncs2[20].value)+Number(ncs2[22].value)).toFixed(2);
        	ncs2[27].value = (Number(ncs2[14].value)+Number(ncs2[23].value)+Number(ncs2[25].value)).toFixed(2);
        	ncs2[32].value = (Number(ncs2[30].value)-Number(ncs2[31].value)).toFixed(2);
        	ncs2[39].value = (Number(ncs2[32].value)+Number(ncs2[33].value)+Number(ncs2[34].value)+Number(ncs2[36].value)+Number(ncs2[37].value)+Number(ncs2[38].value)).toFixed(2);
        	ncs2[40].value = (Number(ncs2[27].value)+Number(ncs2[39].value)).toFixed(2);
        	//负债期末数
        	qms2[14].value = (Number(qms2[1].value)+Number(qms2[2].value)+Number(qms2[3].value)+Number(qms2[4].value)+Number(qms2[5].value)+Number(qms2[6].value)+Number(qms2[7].value)+Number(qms2[8].value)+Number(qms2[9].value)+Number(qms2[10].value)+Number(qms2[12].value)+Number(qms2[13].value)).toFixed(2);
        	qms2[23].value = (Number(qms2[16].value)+Number(qms2[17].value)+Number(qms2[18].value)+Number(qms2[19].value)+Number(qms2[20].value)+Number(qms2[22].value)).toFixed(2);
        	qms2[27].value = (Number(qms2[14].value)+Number(qms2[23].value)+Number(qms2[25].value)).toFixed(2);
        	qms2[32].value = (Number(qms2[30].value)-Number(qms2[31].value)).toFixed(2);
        	qms2[39].value = (Number(qms2[32].value)+Number(qms2[33].value)+Number(qms2[34].value)+Number(qms2[36].value)+Number(qms2[37].value)+Number(qms2[38].value)).toFixed(2);
        	qms2[40].value = (Number(qms2[27].value)+Number(qms2[39].value)).toFixed(2);
        	//加逗号
        	for(var l=0;l<ncs2.length;l++){
         		ncs2[l].value = addCommas2(ncs2[l].value);
         		qms2[l].value = addCommas2(qms2[l].value);
        	}
        	if(ncs1[40].value!=ncs2[40].value){
        		ncs1[40].style.color='red';
        		ncs2[40].style.color='red';
        		return 1;
        	}else{
        		ncs1[40].style.color='black';
        		ncs2[40].style.color='black';
        	}
        	if(qms1[40].value!=qms2[40].value){
        		qms1[40].style.color='red';
        		qms2[40].style.color='red';
        		return 1;
        	}else{
        		qms1[40].style.color='black';
        		qms2[40].style.color='black';
        	}
        }
        function cancel(){
	    ...
	    function callback(msg){
	       	if(msg!='1'){
        		var form = document.getElementById("form1");
				form.action = "BbsbCwbbServlet?action=readZcfzbQYJTExcel&URL="+msg;
				form.submit();
	       	}else{
	       		alert("上传冲突，请稍后再试");
	       		return;
	...
	<% } %>
		...
		<input name="tjzt" id="tjzt" type="hidden" value=""/>
			...
			<table id="table2" width="100%" border=1  cellpadding=0 cellspacing=0 style="">
				...
				<tr>
					<td align="left">以公允价值计量且其变动计入当期损益的金融资产
					<input name="mc1" type="hidden" value="以公允价值计量且其变动计入当期损益的金融资产"/>
					</td>
					<td align="center">2
				...
				<tr>
					...
					<td align="center">
					<input name="ncs1" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbzcList.size()!=0){%>value="<%=CwbbZcfzbzcList.get(8).getNcs()%>"<%}%>/>
					</td>
					<td align="center">
					<input name="qms1" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbzcList.size()!=0){%>value="<%=CwbbZcfzbzcList.get(8).getQms()%>"<%}%>/>
					</td>
					<td align="left">应交税费
				...
				<tr>
					...
					<td align="center">
					<input name="ncs2" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbfzList.size()!=0){%>value="<%=CwbbZcfzbfzList.get(14).getNcs()%>"<%}%>/>
					</td>
					<td align="center">
					<input name="qms2" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbfzList.size()!=0){%>value="<%=CwbbZcfzbfzList.get(14).getQms()%>"<%}%>/>
					</td>
				</tr>
				<tr>
					<td align="left">非流动资产：
				...
				<tr>
					<td align="left">可供出售的金融资产
					<input name="mc1" type="hidden" value="可供出售的金融资产"/>
					</td>
					<td align="center">15
				...
				<tr>
					...
					<td align="left">递延收益
					<input name="mc2" type="hidden" value="递延收益"/>
					</td>
					<td align="center">53
				...
				<tr>
					...
					<td align="center">
					<input name="ncs1" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbzcList.size()!=0){%>value="<%=CwbbZcfzbzcList.get(22).getNcs()%>"<%}%>/>
					</td>
					<td align="center">
					<input name="qms1" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbzcList.size()!=0){%>value="<%=CwbbZcfzbzcList.get(22).getQms()%>"<%}%>/>
					</td>
				...
				<tr>
					...
					<td align="center">
					<input name="ncs1" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbzcList.size()!=0){%>value="<%=CwbbZcfzbzcList.get(26).getNcs()%>"<%}%>/>
					</td>
					<td align="center">
					<input name="qms1" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbzcList.size()!=0){%>value="<%=CwbbZcfzbzcList.get(26).getQms()%>"<%}%>/>
					</td>
					<td align="left">
					<input name="mc2" type="hidden" value=""/>
					</td>
				...
				<tr>
					...
					<td align="center">
					<input name="ncs2" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbfzList.size()!=0){%>value="<%=CwbbZcfzbfzList.get(27).getNcs()%>"<%}%>/>
					</td>
					<td align="center">
					<input name="qms2" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbfzList.size()!=0){%>value="<%=CwbbZcfzbfzList.get(27).getQms()%>"<%}%>/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="left">所有者（股东）权益：
					<input name="mc2" type="hidden" value="所有者（股东）权益："/>
					</td>
					<td align="center">
					<input name="hc2" type="hidden" value=""/>
					</td>
				...
				<tr>
					...
					<td align="center">
					<input name="ncs1" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbzcList.size()!=0){%>value="<%=CwbbZcfzbzcList.get(32).getNcs()%>"<%}%>/>
					</td>
					<td align="center">
					<input name="qms1" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbzcList.size()!=0){%>value="<%=CwbbZcfzbzcList.get(32).getQms()%>"<%}%>/>
					</td>
					<td align="left">实收资本（股本）净额
					<input name="mc2" type="hidden" value="实收资本（股本）净额"/>
					</td>
					<td align="center">60
					<input name="hc2" type="hidden" value="60"/>
					</td>
					<td align="center">
					<input name="ncs2" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbfzList.size()!=0){%>value="<%=CwbbZcfzbfzList.get(32).getNcs()%>"<%}%>/>
					</td>
					<td align="center">
					<input name="qms2" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbfzList.size()!=0){%>value="<%=CwbbZcfzbfzList.get(32).getQms()%>"<%}%>/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td align="left">其他非流动资产
					<input name="mc1" type="hidden" value="其他非流动资产"/>
					</td>
					<td align="center">32
					...
					<td align="left">其他综合收益
					<input name="mc2" type="hidden" value="其他综合收益"/>
					</td>
					<td align="center">64
				...
				<tr>
					...
					<td align="left">专项储备
					<input name="mc2" type="hidden" value="专项储备"/>
					</td>
					<td align="center">65
				...
				<tr>
					...
					<td align="center">
					<input name="ncs2" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbfzList.size()!=0){%>value="<%=CwbbZcfzbfzList.get(39).getNcs()%>"<%}%>/>
					</td>
					<td align="center">
					<input name="qms2" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbfzList.size()!=0){%>value="<%=CwbbZcfzbfzList.get(39).getQms()%>"<%}%>/>
					</td>
				</tr>
				<tr>
					<td align="left">资产总计
					...
					<td align="center">
					<input name="ncs1" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbzcList.size()!=0){%>value="<%=CwbbZcfzbzcList.get(40).getNcs()%>"<%}%>/>
					</td>
					<td align="center">
					<input name="qms1" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbzcList.size()!=0){%>value="<%=CwbbZcfzbzcList.get(40).getQms()%>"<%}%>/>
					</td>
					...
					<td align="center">
					<input name="ncs2" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbfzList.size()!=0){%>value="<%=CwbbZcfzbfzList.get(40).getNcs()%>"<%}%>/>
					</td>
					<td align="center">
					<input name="qms2" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbfzList.size()!=0){%>value="<%=CwbbZcfzbfzList.get(40).getQms()%>"<%}%>/>
					</td>
				</tr>
			</table>
		</form>
