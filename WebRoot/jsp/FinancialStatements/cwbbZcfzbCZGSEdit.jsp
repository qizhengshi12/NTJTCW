  ...
  <head>
	...
	<script type="text/javascript">
        ...
        function verification(){
        	...
        	qms1[34].value="";
        	//资产年初数
        	ncs1[6].value = (Number(ncs1[4].value)-Number(ncs1[5].value)).toFixed(2);
        	ncs1[15].value = (Number(ncs1[1].value)+Number(ncs1[2].value)+Number(ncs1[3].value)+Number(ncs1[6].value)+Number(ncs1[7].value)+Number(ncs1[8].value)+Number(ncs1[9].value)+Number(ncs1[10].value)+Number(ncs1[11].value)+Number(ncs1[12].value)+Number(ncs1[13].value)).toFixed(2);
        	ncs1[21].value = (Number(ncs1[19].value)-Number(ncs1[20].value)).toFixed(2);
        	ncs1[25].value = (Number(ncs1[21].value)+Number(ncs1[22].value)+Number(ncs1[23].value)+Number(ncs1[24].value)).toFixed(2);
        	ncs1[29].value = (Number(ncs1[27].value)+Number(ncs1[28].value)).toFixed(2);
        	ncs1[35].value = (Number(ncs1[15].value)+Number(ncs1[17].value)+Number(ncs1[25].value)+Number(ncs1[29].value)+Number(ncs1[31].value)+Number(ncs1[33].value)).toFixed(2);
        	//资产期末数
        	qms1[6].value = (Number(qms1[4].value)-Number(qms1[5].value)).toFixed(2);
        	qms1[15].value = (Number(qms1[1].value)+Number(qms1[2].value)+Number(qms1[3].value)+Number(qms1[6].value)+Number(qms1[7].value)+Number(qms1[8].value)+Number(qms1[9].value)+Number(qms1[10].value)+Number(qms1[11].value)+Number(qms1[12].value)+Number(qms1[13].value)).toFixed(2);
        	qms1[21].value = (Number(qms1[19].value)-Number(qms1[20].value)).toFixed(2);
        	qms1[25].value = (Number(qms1[21].value)+Number(qms1[22].value)+Number(qms1[23].value)+Number(qms1[24].value)).toFixed(2);
        	qms1[29].value = (Number(qms1[27].value)+Number(qms1[28].value)).toFixed(2);
        	qms1[35].value = (Number(qms1[15].value)+Number(qms1[17].value)+Number(qms1[25].value)+Number(qms1[29].value)+Number(qms1[31].value)+Number(qms1[33].value)).toFixed(2);
        	//加逗号
        	...
        	qms2[34].value="";
        	//负债年初数
        	ncs2[15].value = (Number(ncs2[1].value)+Number(ncs2[2].value)+Number(ncs2[3].value)+Number(ncs2[4].value)+Number(ncs2[5].value)+Number(ncs2[6].value)+Number(ncs2[7].value)+Number(ncs2[8].value)+Number(ncs2[9].value)+Number(ncs2[10].value)+Number(ncs2[11].value)+Number(ncs2[12].value)+Number(ncs2[13].value)).toFixed(2);
        	ncs2[21].value = (Number(ncs2[17].value)+Number(ncs2[18].value)+Number(ncs2[19].value)+Number(ncs2[20].value)).toFixed(2);
        	ncs2[24].value = (Number(ncs2[15].value)+Number(ncs2[21].value)+Number(ncs2[23].value)).toFixed(2);
        	ncs2[30].value = (Number(ncs2[26].value)+Number(ncs2[27].value)+Number(ncs2[28].value)+Number(ncs2[29].value)).toFixed(2);
        	ncs2[35].value = (Number(ncs2[24].value)+Number(ncs2[30].value)).toFixed(2);
        	//负债期末数
        	qms2[15].value = (Number(qms2[1].value)+Number(qms2[2].value)+Number(qms2[3].value)+Number(qms2[4].value)+Number(qms2[5].value)+Number(qms2[6].value)+Number(qms2[7].value)+Number(qms2[8].value)+Number(qms2[9].value)+Number(qms2[10].value)+Number(qms2[11].value)+Number(qms2[12].value)+Number(qms2[13].value)).toFixed(2);
        	qms2[21].value = (Number(qms2[17].value)+Number(qms2[18].value)+Number(qms2[19].value)+Number(qms2[20].value)).toFixed(2);
        	qms2[24].value = (Number(qms2[15].value)+Number(qms2[21].value)+Number(qms2[23].value)).toFixed(2);
        	qms2[30].value = (Number(qms2[26].value)+Number(qms2[27].value)+Number(qms2[28].value)+Number(qms2[29].value)).toFixed(2);
        	qms2[35].value = (Number(qms2[24].value)+Number(qms2[30].value)).toFixed(2);
        	//加逗号
        	for(var l=0;l<ncs2.length;l++){
         		ncs2[l].value = addCommas2(ncs2[l].value);
         		qms2[l].value = addCommas2(qms2[l].value);
        	}
        	if(ncs1[35].value!=ncs2[35].value){
        		ncs1[35].style.color='red';
        		ncs2[35].style.color='red';
        		return 1;
        	}else{
        		ncs1[35].style.color='black';
        		ncs2[35].style.color='black';
        	}
        	if(qms1[35].value!=qms2[35].value){
        		qms1[35].style.color='red';
        		qms2[35].style.color='red';
        		return 1;
        	}else{
        		qms1[35].style.color='black';
        		qms2[35].style.color='black';
        	}
        }
        function cancel(){
	    ...
	    function callback(msg){
	       	if(msg!='1'){
        		var form = document.getElementById("form1");
				form.action = "BbsbCwbbServlet?action=readZcfzbCZGSExcel&URL="+msg;
				form.submit();
	       	}else{
	       		alert("上传冲突，请稍后再试");
	       		return;
	...
	<% } %>
		...
		<input type="hidden" name="hzbz" id="hzbz" value="CZGS" >
		<input name="tjzt" id="tjzt" type="hidden" value=""/>
			...
			<table id="table2" width="100%" border=1  cellpadding=0 cellspacing=0 style="">
				<tr>
					...
					<td align="center" width="15%">负债及所有者权益
					</td>
					<td align="center" width="5%">行次
					</td>
					<td align="center" width="15%">年初数
				...
				<tr>
					...
					<td align="center">29
					<input name="hc2" type="hidden" value="29"/>
					</td>
					<td align="center">
				...
				<tr>
					...
					<td align="center">30
					<input name="hc2" type="hidden" value="30"/>
					</td>
					<td align="center">
				...
				<tr>
					...
					<td align="center">31
					<input name="hc2" type="hidden" value="31"/>
					</td>
					<td align="center">
				...
				<tr>
					...
					<td align="center">32
					<input name="hc2" type="hidden" value="32"/>
					</td>
					<td align="center">
				...
				<tr>
					<td align="left">减：坏账准备
					<input name="mc1" type="hidden" value="减：坏账准备"/>
					</td>
					<td align="center">5
					...
					<td align="center">33
					<input name="hc2" type="hidden" value="33"/>
					</td>
					<td align="center">
				...
				<tr>
					<td align="left">应收账款净额
					<input name="mc1" type="hidden" value="应收账款净额"/>
					</td>
					<td align="center">6
					...
					<td align="left">其付工资
					<input name="mc2" type="hidden" value="其付工资"/>
					</td>
					<td align="center">34
				...
				<tr>
					...
					<td align="left">未交税金
					<input name="mc2" type="hidden" value="未交税金"/>
					</td>
					<td align="center">36
				...
				<tr>
					...
					<td align="left">未付利润
					<input name="mc2" type="hidden" value="未付利润"/>
					</td>
					<td align="center">37
				...
				<tr>
					...
					<td align="left">其他未交款
					<input name="mc2" type="hidden" value="其他未交款"/>
					</td>
					<td align="center">38
				...
				<tr>
					<td align="left">待处理流动资产净损失
					<input name="mc1" type="hidden" value="待处理流动资产净损失"/>
					</td>
					<td align="center">11
				...
				<tr>
					<td align="left">一年内到期的长期债券投资
					<input name="mc1" type="hidden" value="一年内到期的长期债券投资"/>
					</td>
					<td align="center">12
				...
				<tr>
					...
					<td align="center">
					<input name="ncs2" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbfzList.size()!=0){%>value="<%=CwbbZcfzbfzList.get(15).getNcs()%>"<%}%>/>
					</td>
					<td align="center">
					<input name="qms2" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbfzList.size()!=0){%>value="<%=CwbbZcfzbfzList.get(15).getQms()%>"<%}%>/>
					</td>
				</tr>
				<tr>
					<td align="left">长期投资：
				...
				<tr>
					...
					<td align="center">
					<input name="ncs2" type="text" size="15" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbfzList.size()!=0){%>value="<%=CwbbZcfzbfzList.get(17).getNcs()%>"<%}%>/>
					</td>
					<td align="center">
					<input name="qms2" type="text" size="15" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbfzList.size()!=0){%>value="<%=CwbbZcfzbfzList.get(17).getQms()%>"<%}%>/>
					</td>
				</tr>
				<tr>
					<td align="left">固定资产：
				...
				<tr>
					...
					<input name="mc2" type="hidden" value="长期负债合计"/>
					</td>
					<td align="center">47
					<input name="hc2" type="hidden" value="47"/>
					</td>
					<td align="center">
					<input name="ncs2" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbfzList.size()!=0){%>value="<%=CwbbZcfzbfzList.get(21).getNcs()%>"<%}%>/>
					</td>
					<td align="center">
					<input name="qms2" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbfzList.size()!=0){%>value="<%=CwbbZcfzbfzList.get(21).getQms()%>"<%}%>/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td align="left">待处理固定资产净损失
					<input name="mc1" type="hidden" value="待处理固定资产净损失"/>
					</td>
					<td align="center">21
					...
					<td align="center">
					<input name="ncs2" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbfzList.size()!=0){%>value="<%=CwbbZcfzbfzList.get(24).getNcs()%>"<%}%>/>
					</td>
					<td align="center">
					<input name="qms2" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbfzList.size()!=0){%>value="<%=CwbbZcfzbfzList.get(24).getQms()%>"<%}%>/>
					</td>
				</tr>
				<tr>
					...
					<td align="center">
					<input name="ncs1" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbzcList.size()!=0){%>value="<%=CwbbZcfzbzcList.get(25).getNcs()%>"<%}%>/>
					</td>
					<td align="center">
					<input name="qms1" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbzcList.size()!=0){%>value="<%=CwbbZcfzbzcList.get(25).getQms()%>"<%}%>/>
					</td>
					<td align="left">所有者权益：
					<input name="mc2" type="hidden" value="所有者权益："/>
					</td>
					<td align="center">
					<input name="hc2" type="hidden" value=""/>
					</td>
				...
				<tr>
					<td align="left">无形资产及递延资产：
					<input name="mc1" type="hidden" value="无形资产及递延资产："/>
					</td>
					<td align="center">
					<input name="hc1" type="hidden" value=""/>
					</td>
					...
					<td align="left">实收资本
					<input name="mc2" type="hidden" value="实收资本"/>
					</td>
					<td align="center">50
				...
				<tr>
					<td align="left">递延资产
					<input name="mc1" type="hidden" value="递延资产"/>
					</td>
					<td align="center">24
					...
					<td align="center">
					<input name="ncs2" type="text" size="15" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbfzList.size()!=0){%>value="<%=CwbbZcfzbfzList.get(28).getNcs()%>"<%}%>/>
					</td>
					<td align="center">
					<input name="qms2" type="text" size="15" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbfzList.size()!=0){%>value="<%=CwbbZcfzbfzList.get(28).getQms()%>"<%}%>/>
					</td>
				</tr>
				<tr>
					<td align="left">无形资产及递延资产合计
					<input name="mc1" type="hidden" value="无形资产及递延资产合计"/>
					</td>
					<td align="center">25
					<input name="hc1" type="hidden" value="25"/>
					</td>
					<td align="center">
					<input name="ncs1" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbzcList.size()!=0){%>value="<%=CwbbZcfzbzcList.get(29).getNcs()%>"<%}%>/>
					</td>
					<td align="center">
					<input name="qms1" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbzcList.size()!=0){%>value="<%=CwbbZcfzbzcList.get(29).getQms()%>"<%}%>/>
					</td>
					<td align="left">未分配利润
				...
				<tr>
					<td align="left">其他资产：
					<input name="mc1" type="hidden" value="其他资产："/>
					</td>
					<td align="center">
					<input name="hc1" type="hidden" value=""/>
					</td>
					...
					<td align="center">
					<input name="ncs2" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbfzList.size()!=0){%>value="<%=CwbbZcfzbfzList.get(30).getNcs()%>"<%}%>/>
					</td>
					<td align="center">
					<input name="qms2" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbfzList.size()!=0){%>value="<%=CwbbZcfzbfzList.get(30).getQms()%>"<%}%>/>
					</td>
				</tr>
				<tr>
					<td align="left">其他长期资产
					<input name="mc1" type="hidden" value="其他长期资产"/>
					</td>
					<td align="center">26
				...
				<tr>
					...
					<td align="center">
					<input name="ncs1" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbzcList.size()!=0){%>value="<%=CwbbZcfzbzcList.get(35).getNcs()%>"<%}%>/>
					</td>
					<td align="center">
					<input name="qms1" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbzcList.size()!=0){%>value="<%=CwbbZcfzbzcList.get(35).getQms()%>"<%}%>/>
					</td>
					<td align="left">负债及所有者权益合计
					<input name="mc2" type="hidden" value="负债及所有者权益合计"/>
					</td>
					<td align="center">55
					<input name="hc2" type="hidden" value="55"/>
					</td>
					<td align="center">
					<input name="ncs2" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbfzList.size()!=0){%>value="<%=CwbbZcfzbfzList.get(35).getNcs()%>"<%}%>/>
					</td>
					<td align="center">
					<input name="qms2" type="text" size="15" readonly="readonly" onblur="this.value=addCommas(this.value)" <%if(CwbbZcfzbfzList.size()!=0){%>value="<%=CwbbZcfzbfzList.get(35).getQms()%>"<%}%>/>
					</td>
				</tr>
			</table>
			...
			<table width="100%">
				<tr>
					<td align="left">补充资料：1.已贴现的商业承兑汇票
					<input name="mc1" type="hidden" value="补充资料：1.已贴现的商业承兑汇票"/>
					<input name="hc1" type="text" size="15"  <%if(CwbbZcfzbzcList.size()!=0){%>value="<%=CwbbZcfzbzcList.get(36).getHc()%>"<%}%>/>
					元；
					</td>
				</tr>
				<tr>
					<td align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2.融资租入固定资产原价
					<input name="ncs1" type="hidden" value="2.融资租入固定资产原价"/>
					<input name="qms1" type="text" size="15" <%if(CwbbZcfzbzcList.size()!=0){%>value="<%=CwbbZcfzbzcList.get(36).getQms()%>"<%}%>/>
					元。
					</td>
				</tr>
			</table>
