		...
		<table width="100%">
			<tr class="tr3">
				<td align="center" colspan="4">
					<h1 style="font-family:verdana">编辑人员</h1>
				</td>
			</tr>
			<tr class="tr3">
				...
				<td align="left" width="35%">
					<input type="radio" name="sex" <%if("男".equals(zzxx.getSex())){%>checked="checked"<%}%> value="男">男
					<input type="radio" name="sex" <%if("女".equals(zzxx.getSex())){%>checked="checked"<%}%> value="女">女
				</td>
			</tr>
			<tr class="tr3">
				<td align="center">
			...
			<tr class="tr3">
				...
				<td align="left">
					...
					<%if("管理员".equals(roles)){%>onclick="FindCompany()"<%}%> value="<%=zzxx.getCompany() %>" readonly="readonly" class="STYLE1"/><span id="suggest1"></span>
			...
			<tr class="tr3">
				<td align="center" colspan="4">
					<img alt="保存" width="45px" height="45px" title="保存" style="cursor: pointer;"  src="images/small/send.png" onclick="updatePeron();" onmousedown="this.style.border='solid 1px #A9A9A9'" onmouseup="this.style.border='solid 0px'">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
