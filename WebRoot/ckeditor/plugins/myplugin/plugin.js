...
CKEDITOR.plugins.add('myplugin',
	{		
		init : function (a)
		{
            ...
            a.addCommand(pluginName, CKEDITOR.plugins.myplugin.commands.myplugin);
			//注册一个按钮，来调用自定义插件
			a.ui.addButton('MyButton',
					{
						//editor.lang.mine是我在zh-cn.js中定义的一个中文项，
						//这里可以直接写英文字符，不过要想显示中文就得修改zh-cn.js
						label : "一键排版",
						command : pluginName,
						icon: this.path + "images/evernote.png"
					});
		}
	}
);
        ...
        for (var i = 0; i < tmps.length; i++) {
            ...
            if (tmp.length > 0) {
                ...
                if (f != null) {
                    ...
                    html += "<p style='text-indent:2em;'><span style='font-size:20px;'>" + tmp + "</span></p>\n";
                }
            }
        }
        return html;
